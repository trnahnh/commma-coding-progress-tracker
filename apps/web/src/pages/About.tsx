  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        why: 'Tracks the API box — CPU, memory, disk, and a health check on the live endpoint — and emails an alert the moment the server stops responding or runs hot. Infra health only; app latency and errors ride a separate trace pipeline.',
      },
    ],
  },
  {
